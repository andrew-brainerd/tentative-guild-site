    ...
    <div className="app">
      ...
      <section className="content">
        ...
        <section className="guild-buttons">
          <a href="https://discord.gg/ZGnM9BxRNw" className="button" target="_blank" rel="noreferrer">
            <img src={discordLogo} className="discord-logo" alt="Discord Logo" />
          </a>
          <a href="https://classic.warcraftlogs.com/guild/id/610120" className="button warcraft-logs-button" target="_blank" rel="noreferrer">
